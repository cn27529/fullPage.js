...
*/
function(u,f){u.fp_scrolloverflow=function(){u.IScroll||(IScroll=module.exports);var s="fp-scrollable",n="."+s,t=".active",l=".fp-section",e=l+t,o=".fp-slide",c=".fp-tableCell";function p(t){var i=fp_utils.closest(t,l);return null!=i?parseInt(getComputedStyle(i)["padding-bottom"])+parseInt(getComputedStyle(i)["padding-top"]):0}function r(){var a=this;function s(){var i;fp_utils.hasClass(f.body,"fp-responsive")?(i=a.options.scrollOverflowHandler,e(function(t){fp_utils.hasClass(fp_utils.closest(t,l),"fp-auto-height-responsive")&&i.remove(t)})):e(t)}function t(t){if(!fp_utils.hasClass(t,"fp-noscroll")){fp_utils.css(t,{overflow:"hidden"});var i,s=a.options.scrollOverflowHandler,e=s.wrapContent(),o=fp_utils.closest(t,l),n=s.scrollable(t),r=p(o);null!=n?i=s.scrollHeight(t):(i=t.scrollHeight-r,a.options.verticalCentered&&(i=d(c,t)[0].scrollHeight-r));var h=fp_utils.getWindowHeight()-r;h<i?null!=n?s.update(t,h):(a.options.verticalCentered?(fp_utils.wrapInner(d(c,t)[0],e.scroller),fp_utils.wrapInner(d(c,t)[0],e.scrollable)):(fp_utils.wrapInner(t,e.scroller),fp_utils.wrapInner(t,e.scrollable)),s.create(t,h,a.iscrollOptions)):s.remove(t),fp_utils.css(t,{overflow:""})}}function e(s){d(l).forEach(function(t){var i=d(o,t);i.length?i.forEach(function(t){s(t)}):s(t)})}a.options=null,a.init=function(t,i){return a.options=t,a.iscrollOptions=i,"complete"===f.readyState&&(s(),fullpage_api.shared.afterRenderActions()),u.addEventListener("load",function(){s(),fullpage_api.shared.afterRenderActions()}),a},a.createScrollBarForAll=s}IScroll.prototype.wheelOn=function(){this.wrapper.addEventListener("wheel",this),this.wrapper.addEventListener("mousewheel",this),this.wrapper.addEventListener("DOMMouseScroll",this)},IScroll.prototype.wheelOff=function(){this.wrapper.removeEventListener("wheel",this),this.wrapper.removeEventListener("mousewheel",this),this.wrapper.removeEventListener("DOMMouseScroll",this)};var d=null,h={refreshId:null,iScrollInstances:[],iscrollOptions:{scrollbars:!0,mouseWheel:!0,hideScrollbars:!1,fadeScrollbars:!1,disableMouse:!0,interactiveScrollbars:!0},init:function(t){d=fp_utils.$;var i="ontouchstart"in u||0<navigator.msMaxTouchPoints||navigator.maxTouchPoints;return h.iscrollOptions.click=i,h.iscrollOptions=fp_utils.deepExtend(h.iscrollOptions,t.scrollOverflowOptions),(new r).init(t,h.iscrollOptions)},toggleWheel:function(s){d(n,d(e)[0]).forEach(function(t){var i=t.fp_iscrollInstance;null!=i&&(s?i.wheelOn():i.wheelOff())})},onLeave:function(){h.toggleWheel(!1)},beforeLeave:function(){h.onLeave()},afterLoad:function(){h.toggleWheel(!0)},create:function(s,e,o){d(n,s).forEach(function(t){fp_utils.css(t,{height:e+"px"});var i=t.fp_iscrollInstance;null!=i&&h.iScrollInstances.forEach(function(t){t.destroy()}),i=new IScroll(t,o),h.iScrollInstances.push(i),fp_utils.hasClass(fp_utils.closest(s,l),"active")||i.wheelOff(),t.fp_iscrollInstance=i})},isScrolled:function(t,i){var s=i.fp_iscrollInstance;return!s||("top"===t?0<=s.y&&!fp_utils.getScrollTop(i):"bottom"===t?0-s.y+fp_utils.getScrollTop(i)+1+i.offsetHeight>=i.scrollHeight:void 0)},scrollable:function(t){return d(".fp-slides",t).length?d(n,d(".fp-slide.active",t)[0])[0]:d(n,t)[0]},scrollHeight:function(t){return d(".fp-scroller",d(n,t)[0])[0].scrollHeight},remove:function(t){if(null!=t){var i=d(n,t)[0];if(null!=i){var s=i.fp_iscrollInstance;null!=s&&s.destroy(),i.fp_iscrollInstance=null,d(".fp-scroller",t)[0].outerHTML=d(".fp-scroller",t)[0].innerHTML,d(n,t)[0].outerHTML=d(n,t)[0].innerHTML}}},update:function(t,i){clearTimeout(h.refreshId),h.refreshId=setTimeout(function(){h.iScrollInstances.forEach(function(t){t.refresh(),fullpage_api.silentMoveTo(fp_utils.index(d(e)[0])+1)})},150),fp_utils.css(d(n,t)[0],{height:i+"px"}),fp_utils.css(d(n,t)[0].parentNode,{height:i+p(t)+"px"})},wrapContent:function(){var t=f.createElement("div");t.className=s;var i=f.createElement("div");return i.className="fp-scroller",{scrollable:t,scroller:i}}};return{iscrollHandler:h}}()}(window,document);
